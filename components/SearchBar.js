      ...
      <>
       <div className="relative w-full text-gray-400 focus-within:text-gray-600">
            ...
            value={query}
                name="search-field"
                id="search-field"
                className="text-sm h-full w-full border-transparent py-2 pl-8 pr-3  text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent focus:placeholder-gray-400"
